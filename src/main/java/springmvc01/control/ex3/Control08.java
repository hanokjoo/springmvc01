...
public class Control08 {
  /* JSP에 데이터 보내기
   * => 기존 방식: HttpServetRequest 보관소에 직접 담는다.
   * => 스프링 방식: Model, Map 객체에 담아서 전달하면, 프론트 컨트롤러가 이것을 꺼내 
   *    다시 HttpServeltRequest 보관소에 담는다.
   */
  @RequestMapping("/ex3/test11")
  public void test11(HttpServletRequest request) {
    request.setAttribute("name", "홍길동");
    request.setAttribute("age", 20);
    request.setAttribute("tel", "111-1111");
  }
  ...
  public void test13(Model model) {
    ...
    model.addAttribute("tel", "111-1111");
  }
  
  @RequestMapping("/ex3/test14")
  public ModelMap test14() {
